...
via lib/ui.py — this page now uses those helpers too. Post-Day-20 — the
whole dashboard was re-themed to match the deck's own visual identity;
see lib/theme.py's docstring for the full design plan.
...
- Admin Dashboard — cross-team analytics, project success rates,
